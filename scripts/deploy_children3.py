...
if '1' in sys.argv:
    child1_sock.sendto(b"3", (UDP_CHILD1_IP, UDP_CHILD1_PORT))
if '2' in sys.argv:
    child2_sock.sendto(b"3", (UDP_CHILD2_IP, UDP_CHILD2_PORT))
if '3' in sys.argv:
    child3_sock.sendto(b"3", (UDP_CHILD3_IP, UDP_CHILD3_PORT))
if '4' in sys.argv:
    child4_sock.sendto(b"3", (UDP_CHILD4_IP, UDP_CHILD4_PORT))

time.sleep(1)

if '1' in sys.argv:
    child1_sock.sendto(b"0.1,0.1", (UDP_CHILD1_IP, UDP_CHILD1_PORT))
if '2' in sys.argv:
    child2_sock.sendto(b"0.1,0.1", (UDP_CHILD2_IP, UDP_CHILD2_PORT))
if '3' in sys.argv:
    child3_sock.sendto(b"0.1,0.1", (UDP_CHILD3_IP, UDP_CHILD3_PORT))
if '4' in sys.argv:
    child4_sock.sendto(b"0.1,0.1", (UDP_CHILD4_IP, UDP_CHILD4_PORT))
